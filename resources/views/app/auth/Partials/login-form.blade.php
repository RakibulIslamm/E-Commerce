<form method="POST" action="{{ route('app.login') }}" class="w-full">
    ...
    <div>
        ...
        <x-text-input id="login_email" class="block mt-1 w-full" type="email" name="email" :value="old('email')" required
    ...
    <div class="block mt-4">
        <label for="remember_me" class="inline-flex items-center">
            ...
            <span class="ms-2 text-sm text-gray-600">{{ __('Resta collegato') }}</span>
        </label>
    </div>
